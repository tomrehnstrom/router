...
export const withVariable = TanStackStart.createServerFn('GET', (...args: Parameters<Parameters<typeof TanStackStart.createServerFn>[1]>) => {
  "use server";
...
export const withZodValidator = TanStackStart.createServerFn('GET', (...args: Parameters<Parameters<typeof TanStackStart.createServerFn>[1]>) => {
  "use server";
