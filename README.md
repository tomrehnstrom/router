...
A Tanstack router fork with an improved `useBlocker` hook and a new `usePromiseBlocker` hook
...
`"@tanstack/react-router": "npm:@betterblockingrouter/react-router@1.79.1",`
